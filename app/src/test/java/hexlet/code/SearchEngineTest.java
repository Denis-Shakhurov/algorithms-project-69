...
public class SearchEngineTest {
    ...
    public void testSearch() {
        ...
        List<String> expected = List.of("garbage_patch_spam", "garbage_patch_NG", "garbage_patch_ocean_clean", "garbage_patch_wiki");
        List<String> actual = SearchEngine.search(docs, "trash island");
    ...
    public void testGetIndex() {
        ...
        Map<String, List<String>> actual = Index.getIndex(docs);
